...
export default function Home() {
  return (
    <Container>
      ...
      <TwoColumn>
        <PostBody>
          <h2 style={{ marginTop: "var(--space-xs)" }}>About Me</h2>
          <p>
            大学時代は会津大学で情報工学を学び、卒業論文ではブロックチェーン技術に焦点を当てました。具体的には、ノーコードでフルオンチェーンNFTを開発できるWebアプリケーションの制作に取り組みました。
            卒業後は、さらに専門性を深めるため、情報科学芸術大学院大学（IAMAS）に進学しました。ここでは、NFTアートの可能性を探求し、この新しい媒体ならではの芸術表現の方法を模索しています。技術と芸術の融合点に立ち、これまでにない創造的な表現を追求しています。
          </p>
          <h2>Skill Set</h2>
